// Bash: GOOS=js GOARCH=wasm go build -o ./assets/json.wasm ./cmd/wasm/main.go
// Powershell: $Env:GOOS = "js"; $Env:GOARCH = "wasm"; go build -o ./assets/json.wasm ./cmd/wasm/main.go
// RUN BUILD COMMANDS IN SEPARATE POWERSHELL INSTANCE
// HAVE NOT TESTED THE ABOVE FOR BASH
